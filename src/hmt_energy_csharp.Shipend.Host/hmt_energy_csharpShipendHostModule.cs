...
namespace hmt_energy_csharp
{
    ...
    public class hmt_energy_csharpShipendHostModule : AbpModule
    {
        public override void ConfigureServices(ServiceConfigurationContext context)
        {
            ...
            ConfigureWebSocketClient(context, configuration);
            ...
            //ConfigureMqtt(context, configuration);
        }

        private void ConfigureWebSocketClient(ServiceConfigurationContext context, IConfiguration configuration)
        {
        }

        private void ConfigureMqtt(ServiceConfigurationContext context, IConfiguration configuration)
        {
            context.Services.AddHostedService<MqttService>();
        }
        ...
        {
            context.Services.AddSingleton(new TcpClientService(configuration["TcpClient:Address"], Convert.ToInt32(configuration["TcpClient:Port"])));
        ...
        public override void OnApplicationInitialization(ApplicationInitializationContext context)
        {
            ...
            app.UseConfiguredEndpoints(action =>
            {
                ...
                action.MapGrpcService<NavigationConfigService>();
            });
        }
    }
}