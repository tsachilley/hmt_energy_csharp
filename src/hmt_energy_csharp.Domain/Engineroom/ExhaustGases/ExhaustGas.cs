...
namespace hmt_energy_csharp.Engineroom.ExhaustGases
{
    ...
    [Index(nameof(Number), nameof(ReceiveDatetime), nameof(DeviceNo), IsUnique = true, Name = "UK_ExhaustGas_NRD")]
    public class ExhaustGas : BaseEnergy
    {
        //主机增压器进口排气温度 1701
        ...
        public ExhaustGas(string sentence)
        {
            try
            {
                if (sentence == null)
