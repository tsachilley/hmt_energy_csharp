...
namespace hmt_energy_csharp.Engineroom.MainGeneratorSets
{
    ...
    [Index(nameof(Number), nameof(ReceiveDatetime), nameof(DeviceNo), IsUnique = true, Name = "UK_MainGeneratorSet_NRD")]
    public class MainGeneratorSet : BaseEnergy
    {
        //主发电机组缸套水进机压力 3101
        ...
        public MainGeneratorSet()
        {
        }

        public MainGeneratorSet(string sentence)
        {
            try
            {
                if (sentence == null)
