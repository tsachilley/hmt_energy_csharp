...
namespace hmt_energy_csharp.Engineroom.ScavengeAirs
{
    ...
    [Index(nameof(Number), nameof(ReceiveDatetime), nameof(DeviceNo), IsUnique = true, Name = "UK_ScavengeAir_NRD")]
    public class ScavengeAir : BaseEnergy
    {
        //主机扫气集管温度 1601
        ...
        public ScavengeAir(string sentence)
        {
            try
            {
                if (sentence == null)
