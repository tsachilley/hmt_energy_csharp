...
public class hmt_energy_csharpStatisticsAnalysisHostModule : AbpModule
{
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        ConfigureInitial(context, configuration);
    }

    private void ConfigureInitial(ServiceConfigurationContext context, IConfiguration configuration)
    {
        context.Services.AddHostedService<InitialService>();
    }
    ...
    private void ConfigureGrpc(ServiceConfigurationContext context, IConfiguration configuration)
    {
        ...
        context.Services.AddGrpcHealthChecks().AddCheck("SampleHealthCheck", () => HealthCheckResult.Healthy());
    }
    ...
    public override void OnApplicationInitialization(ApplicationInitializationContext context)
    {
        ...
        {
            action.MapGrpcHealthChecksService();
            action.MapGrpcService<ReportService>();
            action.MapGrpcService<StatisticsAnalysisService>();
        });
    }
}