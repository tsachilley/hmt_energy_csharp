...
namespace hmtenergycsharp.OracleMigrations
{
    ...
    [Migration("20250326030456_Update_Oracle_DefaultUploaded")]
    partial class UpdateOracleDefaultUploaded
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("hmt_energy_csharp.Engineroom.AssistantDecisions.AssistantDecision", b =>
                {
                    ...
                    b.HasIndex(new[] { "Number", "ReceiveDatetime", "Key" }, "UK_AssistantDecision_NRK")
                        .IsUnique()
                        .HasFilter("\"Number\" IS NOT NULL AND \"Key\" IS NOT NULL");
            ...
            modelBuilder.Entity("hmt_energy_csharp.Engineroom.ExhaustGases.ExhaustGas", b =>
                {
                    ...
                    b.Property<double?>("MECyl1AfterTempDev")
                        .HasColumnType("BINARY_DOUBLE");

                    b.Property<double?>("MECyl2AfterTemp")
                        .HasColumnType("BINARY_DOUBLE");

                    b.Property<double?>("MECyl2AfterTempDev")
                        .HasColumnType("BINARY_DOUBLE");

                    b.Property<double?>("MECyl3AfterTemp")
                        .HasColumnType("BINARY_DOUBLE");

                    b.Property<double?>("MECyl3AfterTempDev")
                        .HasColumnType("BINARY_DOUBLE");

                    b.Property<double?>("MECyl4AfterTemp")
                        .HasColumnType("BINARY_DOUBLE");

                    b.Property<double?>("MECyl4AfterTempDev")
                        .HasColumnType("BINARY_DOUBLE");

                    b.Property<double?>("MECyl5AfterTemp")
                        .HasColumnType("BINARY_DOUBLE");

                    b.Property<double?>("MECyl5AfterTempDev")
                        .HasColumnType("BINARY_DOUBLE");

                    b.Property<double?>("MECyl6AfterTemp")
                        .HasColumnType("BINARY_DOUBLE");

                    b.Property<double?>("MECyl6AfterTempDev")
                        .HasColumnType("BINARY_DOUBLE");
